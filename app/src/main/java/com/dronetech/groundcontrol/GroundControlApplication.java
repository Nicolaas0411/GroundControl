...
/**
 * Created by Nicolaas on 6/28/16.
 */
public class GroundControlApplication extends Application {

    public static final String FLAG_CONNECTION_CHANGE = "ground_control_connection_change";
